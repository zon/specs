...
3. Verify `specs/architecture.yaml` is in order against the [Architecture Format](docs/specs/architecture-outline.md), and that each component matches what the code does.
