...
1. **Read the [Agent Skills spec](https://agentskills.io/specification)** defining the skill format. The frontmatter `name` must match the directory name, and the `description` is the trigger, naming the situations that should call the skill.
